...
7.  By default, the test suites use Exchange Web Service and Windows
    ...
    [Set the test suite to interactive mode](#set-the-test-suite), skip the
    following steps.
...
#### Set the test suite to interactive mode <a name="set-the-test-suite"> </a>
...
4.  By default, the test suites use Windows PowerShell script in the SUT
    ...
    for the SUT control adapter as described in section [Set the test suite to interactive mode](#set-the-test-suite), skip this step.
